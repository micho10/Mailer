...
/**
  * This is an event sourced entity. It has a state, [[MailerState]], which
...
class MailEntity extends PersistentEntity {
  ...
  override type State = MailerState

  /**
    * The initial state. This is used if there is no snapshotted state to be found.
    */
  override def initialState: MailerState = MailerState("Hello", LocalDateTime.now.toString)
  ...
  override def behavior: Behavior = {
    case MailerState(message, _) => Actions().onCommand[UseGreetingMessage, Done] {
...
/**
  ...
  */
case class MailerState(message: String, timestamp: String)
...
object MailerState {
  /**
    ...
    */
  implicit val format: Format[MailerState] = Json.format
}
